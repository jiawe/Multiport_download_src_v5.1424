 ...
 * Description:
 * ------------
 *   META Camera Calibration Tool interfaces. 
 *
 * Author:
 * -------
 *	 Amos Hsu
 ...
 *------------------------------------------------------------------------------
 * $Revision:   1.14  $
 * $Modtime:   Jan 13 2006 15:10:24  $
 * $Log:   //mtkvs01/vmdata/meta_dll/archives/maui/META_DLL/meta_cct.h-arc  $
 *
 * 03 21 2010 yh.sung
 * [STP100003854][META_DLL] META_DLL 6.1012.0 release 
 * .
 *
 * 01 25 2010 shumin.chen
 * [STP100003683][Meta] META_DLL_v6.0952.0_3G 
 * [STP100003683] [Meta] META_DLL_v6.0952.0_3G
 *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  * check in META DLL_v6.0952.0_3G
 *
 * Feb 27 2009 mtk02173
 * [STP100001910] [META DLL] Check in official version 5.0908.00
 * 
 *
 * Jun 13 2008 MTK02173
 * [STP100001735] [META DLL] CDT 6238 Flash, AF, AE calibration function.
 * 
 *
 * May 16 2008 MTK02173
 * [STP100001706] [META DLL] CCT 6238 AE, AWB, ISP calibration functions.
 * 
 *
 ...
 *
 * Mar 7 2006 mtk00539
 * [STP100000655] [META_DLL][CCT] Add DeviceTool calibration functions.
 * 
 *
 * Mar 7 2006 mtk00539
 ...
 * 
 * 
 *    Rev 1.14   Jan 18 2006 18:11:36   mtk00539
 * New features:
 ...
 * 
 *    Rev 1.13   Dec 29 2005 21:39:54   mtk00539
 *  1. [CCT] Fast capture via USB.
 * Resolution for 157: [META_DLL v3.7.0010][New][CCT] Fast capture via USB.
 * 
 *    Rev 1.12   Nov 28 2005 09:52:12   mtk00539
 *  1. [CCT][New] Add read auto-defect count function.
 * Resolution for 153: [META_DLL v3.7.0009][CCT][New] Add read auto-defect count function.
 * 
 *    Rev 1.11   Nov 18 2005 10:21:54   mtk00539
 ...
 * 
 *    Rev 1.10   Nov 01 2005 10:20:54   mtk00539
 ...
 * 
 *    Rev 1.9   Sep 28 2005 15:37:34   mtk00539
 *  1. [CCT][New] Add new tag CCT_VK_SC_CURVE_SEL.
 * Resolution for 136: [META_DLL v3.7.0005][CCT][New] Add new tag CCT_VK_SC_CURVE_SEL.
 * 
 *    Rev 1.8   Sep 13 2005 15:21:48   mtk00539
 *  1. Support MT6226.
 *  2. [CCT][New] Support MT6227 new NVRAM LIDs C code generation.
 *  3. [CCT][New] Add new tags, CCT_VK_OPD_SUPSEL and CCT_VK_OPD_Y_LIMIT.
 * Resolution for 127: [META_DLL v3.7.0004][CCT][New] Support MT6227 new NVRAM LIDs C code generation.
 * 
 *    Rev 1.7   Aug 10 2005 13:31:24   mtk00539
 ...
 * 
 *    Rev 1.6   Jun 17 2005 17:09:52   mtk00539
 ...
 * 
 *    Rev 1.5   May 24 2005 22:36:24   mtk00539
 ...
 * 
 *    Rev 1.4   Apr 18 2005 09:44:02   mtk00539
 ...
 * 
 *    Rev 1.3   Dec 23 2004 19:50:16   mtk00539
 *  1. [CCT][BUG FIX] Fix parser in ImportProfile(), the same register should not add into sub-category twice.
 *  2. [CCT][New] Add 9 tags Axis R Gain,Axis G Gain,Axis B Gain, U Gain, V Gain, RB+, RB-, MG+, MG- for AWB.
 * Resolution for 102: [META_DLL v3.5.0603][CCT][New] Add 9 tags Axis R Gain,Axis G Gain,Axis B Gain, U Gain, V Gain, RB+, RB-, MG+, MG- for AWB.
 * 
 *    Rev 1.2   Aug 17 2004 14:52:52   mtk00539
 ...
 * 
 *    Rev 1.1   May 28 2004 21:19:38   mtk00539
 ...
 * 
 *    Rev 1.0   Apr 28 2004 11:48:56   mtk00539
 * Initial revision.
 * 
 *------------------------------------------------------------------------------
...
META_RESULT __stdcall META_CCT_Init_with_dual_support(bool bEnableUSBCOM, bool bSupportDualBackupCamera, CCT_SENSOR_TYPE_ENUM cameraType, CCT_Dual_Dev_ISP_camera_sensor_prefix_name_struct* p_sensor_prefix_name, CCT_Dual_Dev_ISP_camera_lens_prefix_name_struct *p_lens_prefix_name) ;  // for support dual camera project
