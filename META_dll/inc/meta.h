...
/* [Dual Talk] */
//Josh 20130607 for MT6582 world phone
typedef struct
{
...
#define GET_GSM_VERSION(x) ((x) & 0x0001) 
    //---------------------------------------------------------------------------
    // Josh 20121210
    // for GMSK new feature
    // When the sw capability for GMSK Battery Compensation is equal to 1,
    // And in 14-bits paramter, LSB of last 7 bits equals 1.
    // unit conversion for GMSK Battery Compensation becomes as dBm,
    // otherwise, in 14-bits paramter, LSB of last 7 bits equals 0.,
    // unit conversion for GMSK Battery Compensation do not change (still use weighting)
    //---------------------------------------------------------------------------
...
typedef struct
{
    RfFactoryModeCalItem cap_id;
    RfFactoryModeCalItem afc;
    RfFactoryModeCalItem rx_pathloss;
    RfFactoryModeCalItem tx_pcl;
    RfFactoryModeCalItem tx_subband;
    RfFactoryModeCalItem trx_offset;
    RfFactoryModeCalItem tx_iq;
    RfFactoryModeCalItem tx_fb_dac;
    RfFactoryModeCalItem tx_slope_skew;
    RfFactoryModeCalItem w_coef;
    RfFactoryModeCalItem txpc;
    RfFactoryModeCalItem temp_adc;
    RfFactoryModeCalItem remove_32k_xo;
    RfFactoryModeCalItem co_crystal;
    RfFactoryModeCalItem high_lna_sp;
    RfFactoryModeCalItem mid_lna_sp;
    RfFactoryModeCalItem low_lna_sp;
    //RfFactoryModeCalItem battery_comp_in_db;  
	RfFactoryModeCalItem bat_temp_comp;  //Josh 20121210 for EDGE battery comp.
    //---------------------------------------------------------------------------
    // Josh 20121210
    // for EPSK new feature
    // When the sw capability for EDGE Battery Compensation is equal to 1,
    // And in 14-bits paramter, LSB of first 7 bits equals 1.
    // unit conversion for EDGE Battery Compensation becomes as dBm,
    // otherwise, in 14-bits paramter, LSB of first 7 bits equals 0.,
    // unit conversion for EDGE Battery Compensation do not change (still use weighting)
    //---------------------------------------------------------------------------
    RfFactoryModeCalItem dts_gain_cmb;
    RfFactoryModeCalItem uts_band_cmb;
    //---------------------------------------------------------------------------
    ...
    //---------------------------------------------------------------------------
    RfFactoryModeCalItem co_temp_adc;
    //---------------------------------------------------------------------------
    ...
    //---------------------------------------------------------------------------
    RfFactoryModeCalItem adjustable_lna_mode_pathloss;
    //------------------------------------------------------
