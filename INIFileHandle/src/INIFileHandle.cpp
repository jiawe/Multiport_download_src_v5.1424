...
bool CINIFileHandle::read_DLStessTestFlag(AnsiString asSetupFile, AnsiString asExeName)
{
	AnsiString as_flag = read_field(asSetupFile, asExeName, "form", "Enable Download Stess Test", "0");
...
void CINIFileHandle::write_DLStessTestFlag(AnsiString asSetupFile, AnsiString asExeName, bool flag)
{
	if(flag)
    {
        write_field(asSetupFile, asExeName, "form", "Enable Download Stess Test", "1");
    }
    else
    {
        write_field(asSetupFile, asExeName, "form", "Enable Download Stess Test", "0");
    }
}
